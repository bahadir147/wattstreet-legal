...
<h3>g) In-app purchases (if/when available)</h3>
<p>If the game offers purchases, payments are processed entirely by Google Play or the Apple App Store. We never receive your card or bank details. We only receive a purchase confirmation (such as a product ID and order/transaction ID) so we can deliver what you bought.</p>
...
("Purchases (if/when available)", """<p>If the game offers purchases, they are made through Google Play or the Apple App Store and are subject to their terms and refund policies. Your statutory consumer rights are not affected.</p>"""),
