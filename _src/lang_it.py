...
<p>Non raccogliamo nome, indirizzo email (salvo che tu ci scriva), numero di telefono, contatti, foto o file, posizione precisa o approssimativa tramite i servizi di localizzazione, né dati di fotocamera o microfono. Il gioco non ha chat né funzioni social. Non usiamo il servizio Unity Analytics né servizi di segnalazione dei crash. Il motore Unity stesso può inviare a Unity informazioni tecniche limitate (ad esempio modello del dispositivo, sistema operativo e versione del motore), come descritto nell’<a href="%U_PRIV%">informativa sulla privacy di Unity</a>.</p>"""),
